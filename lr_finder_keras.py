...
#taken from https://github.com/WittmannF/LRFinder
...
class LRFinder(Callback):
    ...
    def on_train_end(self, logs=None):
        ...
        plt.xlabel("Learning Rate", fontsize=25)#G: added fontsize parameters
        plt.ylabel("Loss", fontsize=25)
        plt.xscale('log')
        plt.grid(True)#G: added grid as default
        plt.xticks(fontsize=15)#G
        plt.yticks(fontsize=15)#G
        plt.show()
