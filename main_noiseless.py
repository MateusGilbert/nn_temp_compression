...
#                 ('cv', (1, 1, 1, 'same'), out_func), ('rs', (smp_size,), None)]),
#  ('CAAE-2.4', [('in', (smp_size,), None), ('dl', cmp_size, hid_act),
#                ('dl', 40, hid_act), ('rs', (40, 1), None), ('d_conv', ((40,1), 8, 3, 2, 4, 40), hid_act), ('h_conv2', ([1, 2, 3], [4, 2, 2], 3, [8, 8, 8]), hid_act),
#                ('up_conv', (8, 3, 2, 8), hid_act),
#                ('cv', (1, 1, 1, 'same'), out_func), ('rs', (smp_size,), None)]),
...
#define log file
train_label = 'noiseless_new_caaes_3_1'
now = datetime.now()
log_file = f'log_{train_label}.txt'#{now.strftime("%m_%d_%H_%M")}.txt'
#####
seed(1671)
...
og_dir = os.getcwd()
dirname = func(models=models, dir_id=f'{train_label}_results_', cols=cols, verbose=False, lr_list=lr_vals, log_file=os.path.join(og_dir,log_file))
